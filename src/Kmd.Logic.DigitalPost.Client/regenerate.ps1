autorest --input-file=digitalpost.swagger.json --output-folder=. --namespace=Kmd.Logic.DigitalPost.Client --csharp --override-client-name=InternalClient --add-credentials
