...
namespace Kmd.Logic.Digitalpost.ConsoleSample.Client
{
    ...
    public partial class DigitalPostClient : ServiceClient<DigitalPostClient>, IDigitalPostClient
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<SendMessageResponse>> SendMessageWithHttpMessagesAsync(System.Guid subscriptionId, SendMessageRequest request = default(SendMessageRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<SendMessageResponse>> SendDocumentWithHttpMessagesAsync(System.Guid subscriptionId, SendDocumentRequest request = default(SendDocumentRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            string apiVersion = "1.1.1";
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<DigitalPostProviderConfigurationModel>> GetDigitalPostConfigurationWithHttpMessagesAsync(System.Guid subscriptionId, System.Guid configurationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            string apiVersion = "1.1.1";
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            ...
            // Create Result
            var _result = new HttpOperationResponse<DigitalPostProviderConfigurationModel>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
        ...
        public async Task<HttpOperationResponse<DigitalPostProviderConfiguration>> UpdateDoc2MailConfigurationWithHttpMessagesAsync(System.Guid subscriptionId, string id = default(string), int? systemId = default(int?), string name = default(string), string environment = default(string), string callbackUrl = default(string), Stream certificate = default(Stream), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<DigitalPostProviderConfiguration>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            // Deserialize Response
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<DigitalPostProviderConfiguration>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
